	...
	JAGE.addGeometryBox = function() {
		...
		tab.innerHTML =
			...
			'</p></a>'; 
		tabGeometry.onclick = function() { JA.toggleTab( JAGE.geometryBox ); };

		JAGE.geometryBox = tab.appendChild( document.createElement( 'div' ) );
		JAGE.geometryBox.style.cssText = 'cursor: auto; display: none;' ;
		JAGE.geometryBox.innerHTML =
