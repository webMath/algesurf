	...
	ASFR.updateIframe = function( number ) {
		...
		ASFR.ifr.onload = function() {
			...
			divMsg1.innerHTML = 'Source: <b><a href=' + ASFR.files[ number ][ 2 ] + ' target=_blank >' + ASFR.files[ number ][ 3 ] + '</a></b>';
			divMsg2.innerHTML = 'File: <b><a href=' + fname + ' target=_blank >' + ASFR.files[ number ][ 1 ] + '</a></b>';
